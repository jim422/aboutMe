...
const scope1 = require('../assets/scope_1.jpg');
const scope2 = require('../assets/scope_2.jpg');
const scope3 = require('../assets/scope_3.png');
const scope4 = require('../assets/scope_4.png');
	...
	return (
		<div className='javascript-container'>
			...
			<p>
				...
				<img src={scope1} className="img-container" />
			</p>

			<p>
				<img src={scope2} className="img-container" />
				...
				<img src={scope3} className="img-container" />
